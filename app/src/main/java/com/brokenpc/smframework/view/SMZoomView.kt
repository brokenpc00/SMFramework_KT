...
class SMZoomView(director: IDirector): UIContainerView(director) {
    ...
    companion object {
        ...
        fun create(director: IDirector): SMZoomView {
            return create(director, 0f, 0f, 0f, 0f, 0f, 0f)
        }

        @JvmStatic
        fun create(director: IDirector, x: Float, y: Float, width: Float, height: Float): SMZoomView {
            return create(director, x, y, width, height, 0f, 0f)
        }
...
//                _velocityTracker = null
    ...
    public override fun performDoubleClick(worldPoint: Vec2?) {
