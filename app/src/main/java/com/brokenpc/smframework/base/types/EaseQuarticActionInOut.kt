...
class EaseQuarticActionInOut(director: IDirector) : ActionEase(director) {
    companion object {
        @JvmStatic
        fun create(director: IDirector, action: ActionInterval?) : EaseQuarticActionInOut? {
            val ease = EaseQuarticActionInOut(director)
