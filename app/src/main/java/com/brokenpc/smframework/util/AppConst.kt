...
class AppConst {
    ...
    object SIZE {
        const val EDGE_SWIPE_MENU = 140.0f
        const val EDGE_SWIPE_TOP = 195.0f
        const val LEFT_SIDE_MENU_WIDTH = 825.0f
        const val TOP_MENU_HEIGHT = 195.0f
        const val TOP_MENU_BUTTON_HEIGHT = 180.0f
        const val MENUBAR_HEIGHT = 195.0f
        const val BOTTOM_MENU_HEIGHT = 240.0f
        const val DOT_DIAMETER = 30.0f
        const val LINE_DIAMETER = 7.5f
        const val TOP_MENU_BUTTONE_SIZE = 180.0f
    }
